...
from code_factory.trackers.linear.ops.ops_files import (
    read_binary_file,
    read_text_file,
    resolve_path,
)
from code_factory.trackers.linear.ops.ops_normalize import normalize_issue
from code_factory.trackers.linear.ops.ops_queries import (
    CREATE_RELATION_MUTATION,
    ISSUE_QUERY,
    ISSUES_QUERY,
)
from code_factory.trackers.linear.ops.ops_resolution import find_exact, find_optional
...
def test_linear_file_and_normalize_remaining_branches(
    ...
    with monkeypatch.context() as patch:
        patch.setattr(
            "code_factory.trackers.linear.ops.ops_files.canonicalize",
...
async def test_linear_read_remaining_branches(
    ...
    monkeypatch.setattr(
        "code_factory.trackers.linear.ops.ops_read.normalize_team",
