...
from code_factory.workspace.review.review_observer import NullReviewObserver
from code_factory.workspace.review.review_runner import _open_browser, _wait_for_exit
from code_factory.workspace.review.review_session import (
...
async def test_run_review_session_prefers_textual_in_interactive_mode(
    ...
    monkeypatch.setattr(
        "code_factory.workspace.review.review_session.run_review_textual_session",
        fake_tui,
    )
...
async def test_run_review_textual_session_success_and_error_paths(
    ...
    monkeypatch.setattr(
        "code_factory.workspace.review.review_textual_app.ReviewTextualApp", FakeApp
    )
    ...
    monkeypatch.setattr(
        "code_factory.workspace.review.review_textual_app.ReviewTextualApp", FailingApp
    )
