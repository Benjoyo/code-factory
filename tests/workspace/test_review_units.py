...
from code_factory.workspace.review.review_browser import wait_for_http_ready
...
async def test_review_runner_runs_prepare_and_cleans_up(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "code_factory.workspace.review.review_runner._create_worktree",
        fake_create_worktree,
    )
    monkeypatch.setattr(
        "code_factory.workspace.review.review_runner._head_sha",
        fake_head_sha,
    )
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        "code_factory.workspace.review.review_runner.ProcessTree.spawn_shell",
        classmethod(fake_spawn_shell),
    )
    monkeypatch.setattr(
        "code_factory.workspace.review.review_runner._open_browser",
