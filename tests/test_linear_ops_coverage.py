...
async def test_linear_common_resolution_and_read_write_helpers_cover_edges(
    ...
    monkeypatch.setattr(
        "code_factory.trackers.linear.ops_write.read_text_file",
    ...
    assert (await ops.update_issue("ENG-1", title="Issue"))["updated"] is True
    ...
    monkeypatch.setattr(
        "code_factory.trackers.linear.ops_write.read_binary_file",
