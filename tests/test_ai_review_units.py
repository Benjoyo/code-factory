...
from code_factory.workflow.review_profiles import WorkflowReviewType
from code_factory.workspace.ai_review_feedback import (
    accepted_review_findings,
    ai_review_feedback_prompt,
)
from code_factory.workspace.ai_review_prompt import (
...
def test_ai_review_prompt_rejects_unexpected_vendored_prompt_shape(
    ...
    monkeypatch.setattr(
        "code_factory.workspace.ai_review_prompt.base_review_prompt",
