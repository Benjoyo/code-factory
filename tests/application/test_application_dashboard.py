...
from code_factory.application.dashboard.dashboard_format import (
    clean_inline,
    int_value,
    mapping_list,
    next_refresh_text,
...
from code_factory.application.dashboard.dashboard_render import (
    _event_style,
    _retry_renderable,
    _running_renderable,
)
from code_factory.application.dashboard.dashboard_workflow import (
    dashboard_link,
    max_agents,
    project_link,
...
async def test_live_status_dashboard_run_and_snapshot_paths(
    ...
    monkeypatch.setattr(
        "code_factory.application.dashboard.dashboard.Live",
...
async def test_live_status_dashboard_run_handles_disabled_then_reenabled(
    ...
    monkeypatch.setattr(
        "code_factory.application.dashboard.dashboard.Live", lambda *a, **k: fake_live
    )
    dashboard = LiveStatusDashboard(
        cast(Any, SnapshotNowOrchestrator()),
        settings=cast(
