...
from code_factory.workspace.review_comments import (
...
async def test_submit_review_comment_success_and_failure(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "code_factory.workspace.review_comments.capture_shell", fake_capture
    )
    ...
    monkeypatch.setattr(
        "code_factory.workspace.review_comments.capture_shell",
